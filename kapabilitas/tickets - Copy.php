...
$where.=$pic!="" && ($s_LVL==0 || $s_LVL==1 || $s_LVL==3)?" and s<>'closed'":""; //all
...
?>
				...
				<?php if(($s_LVL==0||$s_LVL==1||$s_LVL==4)&&$s==''){?>
					<a href="#" onclick="$('#notes').html('');openForm(0);" data-toggle="modal" data-target="#modal_large" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Create</a>
					...
					<div class="">
						...
						<form class="form-horizontal" id="myf">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<label class="col-md-2 control-label">Lokasi ID</label>
									<div class="col-md-4">
										<div class="input-group">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										<select class="form-control" name="typ" id="typ" style="-webkit-appearance: menulist;">
										<?php echo $opttyp?>
										</select>
									</div>
								...
								<?php }?>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="bw" id="bw" placeholder="auto">
										</div>
										<label class="col-md-2 control-label">Keterangan</label>
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="ket" id="ket" placeholder="auto">
										</div>
									</div>
									<!--div class="form-group">
										<label class="col-md-2 control-label">Name</label>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="pic" id="pic" placeholder="auto">
										</div>
										<label class="col-md-2 control-label">PIC 2</label>
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="pic2" id="pic2" placeholder="auto">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="contact" id="contact" placeholder="auto">
										</div>
										<label class="col-md-2 control-label">Contact 2</label>
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="contact2" id="contact2" placeholder="auto">
										</div>
									</div>
	...
	$.ajax({
		...
		success: function(data){
			...
			if(json.length<1){
				...
				//getIP();
				if(json.length>1){
					alert('Hasil lebih dari 1, mohon lebih spesifik.');
				}else{
