...
$rs=exec_qry($conn,"select * from $tname where $where");
$notes = fetch_alla($rs);
                ...
                <div class="page-content-wrap">
					...
					<div class="row">
						<div class="col-md-12">
							...
							$css=$notes[$i]['updby']==$s_ID?$saya:$bukansaya;
							$in=$saya==$css?"in":"";
                                ...
                                <div class="item item-visible <?php echo $in?>">
                                    <div class="text" <?php echo $css?>>
                                        <div class="heading">
                                            ...
                                            <span class="date"><?php echo $notes[$i]['lastupd'] ?></span>
                                        </div>
										(<?php echo $notes[$i]['s'] ?>)<br />
                                        <?php echo $notes[$i]['notes'] ?><br /><br/>
