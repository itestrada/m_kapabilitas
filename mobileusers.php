...
$where="";
$tname="ep_users u left join ep_locations l on u.loc=l.locid";
$tnamex="ep_users";
$cols="uid,uname,locname,u.rowid";
$colsrc="uid,uname,locname";
					...
					<div class="">
						...
						<form class="form-horizontal" id="myf">
							...
							<div class="panel-body">
									...
									<input type="hidden" name="columns" value="uid,uname,loc">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input type="text" class="form-control input-sm" name="uname" id="uname" placeholder="...">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input type="password" class="form-control input-sm" name="hupwd" id="hupwd" placeholder="...">
									</div>
								</div>
